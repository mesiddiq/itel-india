        ...
        <div className={`bg-[#1a1a1a] absolute top-0 w-full overflow-hidden transition-all duration-500 ${smartPhone ? 'h-[330px] py-12 z-[500] ' : 'h-0'}`}>
            <div className="max-w-[1065px] w-full mx-auto flex lg:gap-6 pl-4 xl:pl-0 xl:gap-11">
                <div className="flex flex-col gap-3">
                    {
                        PhoneData.map(({ id }) => (
                            <button key={id} onClick={() => handleClick(id)} className={`flex w-[114px] justify-between gap-2 items-center`}>
                                <h3 className="text-desktop/button text-left uppercase text-white">
                                    {id}
                                </h3>
                ...
                <div className="flex flex-col gap-5 w-full">
                    <h3 className="text-desktop/h6/medium text-blue/blue/5">
                        Feature Product
                    </h3>
            ...
            <div className="max-w-[1065px] w-full mx-auto flex lg:gap-6 pl-4 xl:pl-0 xl:gap-11">
                ...
                <div className="flex flex-col gap-5 w-full">
                    ...
                    {/* <div className="flex gap-2 items-center justify-end">
                        <h3 className=" text-mobile/button text-white text-right uppercase">view all</h3>
                        <ArrowRight />
                    </div> */}
                </div>
            </div>
