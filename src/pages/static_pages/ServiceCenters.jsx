  ...
  return (
    <div className=" font-markot">
      ...
      <div className='lg:bg-[url("/banners/Frame%201973341368.png")] bg-[url("/banners/moblie%20-%20service%20center%20BG.png")]  bg-cover bg-center lg:h-screen w-full lg:p-20 p-10'>
        ...
        <div className=" mt-10 p-4 flex rounded-full space-x-3 items-center  w-[264px] lg:w-[365px] bg-white">
          <p className=" lg:text-mobile/small/button   ">
      ...
      >
        <div className=" space-y-6 lg:py-0 py-5">
          ...
          <div className=" flex p-3 lg:w-[275px] w-[198px]  justify-evenly items-center rounded-full bg-brand/black text-white">
