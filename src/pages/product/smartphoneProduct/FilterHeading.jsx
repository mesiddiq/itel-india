...
const FilterHeading = () => {
  ...
  return (
    <>
    <div className="hidden lg:mb-12 lg:text-left text-center text-black lg:text-white lg:flex flex-row lg:justify-start justify-center items-center gap-2 lg:p-0 py-2 px-9 lg:bg-transparent bg-white lg:rounded-none rounded-3xl ">
        <img src={filter}/>
