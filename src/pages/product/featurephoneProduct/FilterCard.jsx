                ...
                filterOptions.map((option) => (
                    <li key={option} className='flex flex-row justify-start items-center gap-2'>
                        ...
                        <label className="flex items-center cursor-pointer relative">
                            <input type="checkbox" className="peer h-5 w-5 cursor-pointer appearance-none rounded-sm shadow hover:shadow-md border border-[#6F7384] checked:bg-red-600 checked:border-red-600" id="check2" />
