...
export default function ProductCard({ product }) {
	const { isNew, image, name, description, pageUrl, price } = product;
	return (
		<div className=" py-3 md:py-5 px-3 gap-3 rounded-2xl bg-[#232323] flex flex-col flex-wrap justify-around items-center">
			...
			{isNew == true ? (
				...
				<h3 className="md:w-[30px] lg:w-[55px] h-[26px] rounded-full bg-transparent px-3 py-[2px] text-[12px] lg:text-sm leading-[22.4px] tracking-[-0.01em]"></h3>
			)}
			...
			<div className="product-image-card flex justify-center items-center">
				<img
					src={image}
					className="w-2/3 lg:w-[80%] 2xl:w-2/3 max-h-[280px]"
				/>
			</div>
