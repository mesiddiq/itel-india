...
export const FeatureRichDataSuperGuru4g = {
...
export const TechSpecsDataSuperGuru4g = {
    phoneUrl: '/featurephone/superguru4g/techspecs.webp',
    cards: [
        { id: '1', label: '4G/3G/2G', icon: '/featurephone/common/connectivity.svg' },
        { id: '2', label: 'UPI 123 Support', icon: '/featurephone/common/upi.svg' },
        { id: '3', label: '13 Languages Support', icon: '/featurephone/common/language.svg' },
        { id: '4', label: 'VGA Camera', icon: '/featurephone/common/camera.svg' },
        { id: '5', label: '2" Display', icon: '/featurephone/common/display.svg' },
