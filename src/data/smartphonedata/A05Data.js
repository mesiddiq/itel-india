export const a05FeatureRichData = {
    title: "Store More, Worry Less with Massive 64GB ROM",
    description: "Experience breathtaking visuals on the itel A05s smartphone with its expansive 6.6-inch HD+ Drop Notch Display, featuring a crisp 1612 x 720 pixel resolution. Stay powered all day with the robust 4000 mAh battery and Type-C charging support. Effortlessly multitask with 8GB* (4GB+4GB*) RAM and 64GB ROM. Capture stunning photos with the 5MP dual rear camera and enjoy enhanced security with dual protection for your device.",
    cards: [
        {
            id: 1,
...
export const a05ImageCaraousel = [
    {
        id: 1,
        color: "orange",
        buttonText: "Orange",
...
export const a05FullSpecifications = [
    {
        id:1,
        label:'General',
        data:[
