...
import { RoutesData } from './SuperSeriesHeader'
import { Link, useLocation } from 'react-router-dom'


const SuperSeriesStickyHeader = ({
    ...
    return (
        <div className='!sticky -top-1 z-[999] '>
            <div className={`${borderBottom ? 'border border-t-white/10' : 'border-none'} px-4 md:px-0 py-4 md:py-6 font-markot `} style={{ background: bgColor ? bgColor : '#181818' }}>
...
export default SuperSeriesStickyHeader