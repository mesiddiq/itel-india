            ...
            <div className="content h-full flex lg:items-center pt-11 lg:pt-0 px-4 md:px-0">
                <div className="relative z-10">
                    ...
                    >
                        ...
                        >
                            <h3 className="text-[14px] font-extrabold bg-clip-text text-transparent font-bricolage tracking-[0.14px] uppercase" style={{
                    ...
                    >
                        ...
                        >
                            <h3 className={`flex flex-row justify-start items-center gap-1 font-markot lg:text-[20px] lg:leading-[24px] lg:tracking-[0.01em] text-mobile/small/body ${theme == "dark" ? 'text-black/1' : 'text-white'}`}>
