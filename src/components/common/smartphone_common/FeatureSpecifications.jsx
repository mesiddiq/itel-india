...
const FeatureSpecifications = ({featureMetric, featureMetricDescription}) => {
  return (
    <div className='flex flex-col gap-[4px] lg:gap-2 '>
        <span className='FFMarkMedium opacity-80 text-mobile/h6 lg:text-desktop/h3'>
            {featureMetric}
        </span>
        <span className='FFMarkRegular opacity-80 text-mobile/small/body lg:text-desktop/body/1'>
