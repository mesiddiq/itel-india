        ...
        <div className="flex flex-col max-w-full w-[1280px]">
          ...
          <div className="flex flex-wrap gap-5 items-start justify-center mt-9">
            {products.map((product, index) => (
              <div
                key={index}
                className={`flex flex-col px-8 gap-[32px] pt-8 pb-11 rounded-2xl ${
                  isLightTheme ? 'bg-gray-100' : 'bg-neutral-800'
                } min-w-[240px] w-[304px] h-[452px] max-md:px-5 max-md:w-1/2`}
              >
                ...
                <div className="flex flex-col mt-4">
                  <div className="flex flex-col items-center whitespace-nowrap">
                    ...
                    <div className="flex gap-2 items-center mt-3">
                      <p className={`text-desktop/h6/medium font-bold tracking-normal leading-tight ${isLightTheme ? 'text-black' : 'text-white'}`}>
                        {product.price}
                      </p>
