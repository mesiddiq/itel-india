...
Copy contacts to another phone (Both/F/S)
...
Contacts saved on the SIM card may not show up on the phone or may disappear. (Both/F/S)
...
Phone cannot display recent calls.(Both/F/S)
...
The phone displays call barring when dialing.(Both/F/S)
...
Call ended or hung up automatically.(Both/F/S)
...
Cannot answer or receive new incoming calls.(Both/F/S)
...
The phone displays "android process stops" when saving contacts. (SP)
...
When saving contacts, the phone displays that it's in Airplane mode and the contact cannot be saved. (SP)
...
When calling, both sides cannot hear each other.(Both/F/S)
...
There's no ringtone when calls are incoming.(Both/F/S)
...
Some numbers can still be called after they have been set as blacklist.(Both/F/S)
...
When clicking on a certain contact to check the number, the phone always displays "loading" first and shows the number after a while.(SP)
...
When switched on, the phone shows "emergency call."(Both/F/S)
...
Contacts are not displayed in WhatsApp. (SP)
...
It's very slow loading contacts from SIM card, or cannot load contacts from SIM card. (SP)
...
Activate/turn off Auto Call Recording. (SP)
...
How to set SIM card 2 as default mode when sending messages.(Both/F/S)

1. Go to "Settings" and set the default SIM card.

The phone is receiving the same messages repeatedly.(Both/F/S)  
...
Cannot receive new messages, while can send messages.(Both/F/S)
...
Inbox shows "insufficient space" even though all messages have been deleted. (SP)
...
Cannot log in to Google email box. (SP)

1. Ensure that the phone is covered by a high-speed network connection.
2. Delete the email account and log in again.

The phone usually receives warning messages that require upgrading the Android launcher, or else the phone will be locked. (SP)
...
LED light does not work when there are unread messages. (SP)
...
Camera is forced to close and cannot take photos.
...
Pictures taken by the camera are blurry.
...
The camera is broken or not working/cannot take photos.
...
Flash doesn't work when taking pictures or using a flashlight.
...
Phone indicates only 8% battery remaining after fully charging.
...
Phone takes a long time to charge or charges slowly.
...
The phone displays 'battery overcharge' when charging.
...
Experiencing numbness when touching the phone while charging.
...
Abnormal battery level displayed on the phone.
...
# To transfer files without a USB cable, you can use WeChat.
...
# To connect devices via USB Tethering:
...
To connect your device as a USB Mass Storage:
...
To transfer files from your phone's SD card to your computer:
...
If your phone is stuck in earphone mode:
...
If experiencing noise or no earphone input sign on the phone:
...
If unable to connect to the computer, follow these troubleshooting steps based on the feedback from both devices:
...
Accordion Title: How to Use Maps Offline on My Phone

1. Download offline maps when you're on a Wi-Fi connection.

If the phone turns on/off by itself:
...
Phone hangs suddenly and makes loud noises.
...
The phone does not switch on but keeps switching off on its own.
...
The phone auto powers off and on or reboots.
...
Mobile phone shutdown or frequent restart automatically is usually caused by data conflicts or system issues. Here are troubleshooting steps you can follow:
...
### **How to Connect to the Internet / How to Set Up the Network**
...
### **Network Signal is Weak / Mobile Phone Always Has No Signal**
...
### **Does the Phone Support 3G? If Yes, How Do I Disable It?**
...
### **How to Turn Off Data on My Phone**

1. Pull down the notification bar and turn off mobile data.

### **Cannot View Web Page**
...
### **Cannot Connect to Wi-Fi / Recognize Network / How to Connect to Wi-Fi**
...
### **The Speed of Surfing the Internet is Slow and Does Not Show 3G Sign**
...
### **Phone Says Error When Turning on Wi-Fi / Cannot Connect to Wi-Fi**
...
### **Cannot Connect to the Internet Although Data is Sufficient**
...
### **There is Something Wrong with the Network After Resetting the Phone**
...
### **Mobile Data or Wi-Fi Turns On by Itself**
...
### **Why Network Signal and Reception is Poor**
...
### **Cannot Connect to the Mobile Hotspot**
...
### **The Phone Cannot Connect to Wi-Fi**
...
### **Why Can't I Access the 4G Network**
