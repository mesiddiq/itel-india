    ...
    <div className="bg-white space-y-[12px] lg:space-y-[16px] ">
      ...
      <div className=" space-y-3 lg:space-y-4">
        <div className=" space-y-2 ">
          <p className=" text-desktop/body/2/regular text-grey/grey/5">
            {category}
          </p>
          <p className=" lg:text-desktop/h5/medium text-mobile/h6 line-clamp-2 text-brand/black">
            {title}
          </p>
        </div>
        ...
        <Link to={`/blog/${id}`} state={{ data }} className=" inline-block">
          <div className=" flex items-center">
            <p className=" lg:text-desktop/button text-mobile/button text-brand/black">
              VIEW
            </p>
            <img
  ...
  return (
    <div className=" lg:content py-[60px] flex  lg:space-y-[120px] space-y-10 flex-col  items-center px-4 font-markot">
      <div className=" lg:space-y-[60px] lg:w-[846px]">
        <div className=" space-y-[60px]">
          <div className=" space-y-[16px] lg:space-y-[20px]">
            <p className=" text-mobile/h7 lg:text-desktop/h5/medium text-grey/grey/5">
              {Maindata.category}
            </p>
            ...
            <div className=" flex lg:flex-row items-start lg:items-center flex-col lg:space-y-0 space-y-[16px] justify-between">
              <p className=" text-grey/grey/4  text-desktop/body/2/regular lg:text-desktop/body/1">
                {Maindata.publisedon}
              </p>
      ...
      <div className="md:grid md:gap-x-[20px]  gap-y-[52px] md:grid-cols-3">
        {data
          .filter((item) => item.id !== Maindata.id)
          .slice(0, 4)
          .map((data, index) => (
            <BlogCard
