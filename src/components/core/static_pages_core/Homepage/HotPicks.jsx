...
const CardData = [
    ...
    { id: 3, path: '', descriptoin: 'Entertainment Power pack with 5k Google Apps in-built', image: "/static_page/homepage/EnjoyBetterLifeCol3.png", name: "G4365", price: "18,999.00" },
