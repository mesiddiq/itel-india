...
const HotPicks = () => {
    return (
        <div className='content flex flex-col gap-10 px-4 md:px-0'>
            <div className="flex gap-4 items-center">
                <img src="/static_page/Hotstar.gif" alt="" className='max-w-16' />
                <h1 className="text-desktop/h2">Hot Picks: Snag ‘Em Now!</h1>
            </div>
            <div className="">
                ...
                <div className="lg:mt-6 mt-4 flex  justify-between flex-wrap items-center">
                    <div className="rounded-[8px] lg:rounded-[16px] p-3 lg:px-[85px] lg:pt-[86px] lg:max-w-max bg-dark/card/bg flex gap-3 flex-col h-[227px] lg:h-[526px] max-w-[156px]">
                        <img src="/smartphone/S24/Starry Black 1.png" alt="" className='h-[100px] lg:h-[230px] object-contain' />
                        <div className="text-center max-w-[243px]">
                            <h1 className="text-mobile/h6 lg:text-desktop/h4">S24</h1>
                            <p className="text-mobile/small/body text-grey/grey/3 lg:text-desktop/body/2/regular mt-1 lg:mt-2">Your Ideal Storyteller: Stunning 108MP AI Camera</p>
                            <button className="flex gap-[6px] items-center justify-center mx-auto lg:py-2 lg:px-5 lg:rounded-[24px] lg:bg-[#2c2c2c] lg:border-[#4f4f4f] lg:border w-full lg:mt-3">
