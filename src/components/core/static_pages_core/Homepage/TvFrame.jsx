    ...
    return (
        <div className=' overflow-hidden'>
            ...
            <div className="content relative lg:h-screen">
                ...
                >
                    <h3 className="lg:text-[107px] lg:leading-[109px] text-[21px] leading-6 font-bold text-center z-50 absolute top-[40%] lg:scale-[0.6] mx-auto left-1/2 -translate-x-1/2">Endless Entertainment <br /> Awaits </h3>
