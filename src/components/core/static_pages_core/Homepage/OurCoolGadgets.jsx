...
const OurCoolGadgets = () => {
    return (
        <section className='content'>
            ...
            <img src="https://res.cloudinary.com/djwj42mic/image/upload/v1729920395/CoolGAdgets_yszjct.gif" alt="Our Cool Gadgets" className='w-full lg:hidden mt-9' />

            <img src="https://res.cloudinary.com/djwj42mic/image/upload/v1729919881/Gadgets_jsnpaz.gif" alt="Our Cool Gadgets" className='hidden lg:block mt-10' />
