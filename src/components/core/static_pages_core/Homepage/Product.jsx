...
const ProductData = [
    { id: 1, image: '/featurephone/superguru4g/hero.webp', name: 'Super Guru 4G', purchaseLink: '', price: '1,799.00' },
    { id: 2, image: '/featurephone/it5262/Backgrounds/phone_hero.webp', name: 'it5262', purchaseLink: '', price: '1,399.00' },
    { id: 3, image: '/featurephone/it5330/Backgrounds/phone_hero.webp', name: 'it5330', purchaseLink: '', price: '1,499.00' },
    { id: 4, image: '/featurephone/Power_120/Backgrounds/hero_mobile.webp', name: 'Power120', purchaseLink: '', price: '1,249,00' },
]
    ...
    return (
        <div className="p-3 lg:py-9 flex flex-col gap-3 lg:gap-10 h-[202px] lg:h-[452px] max-w-[156px] lg:max-w-[304px] w-full rounded-[8px] bg-dark/card/bg">
            ...
            <div className="flex flex-col items-center ">
                ...
                <a href={purchaseLink} className='flex  items-center gap-[6px] lg:gap-2 lg:mt-6 mt-1'>
