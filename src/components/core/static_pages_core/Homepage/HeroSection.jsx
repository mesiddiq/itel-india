    ...
    return (
        <AnimatePresence mode='wait'>
            <div key={activeSlide} className="relative h-[520px] md:h-[550px] lg:h-[627px]  flex justify-center  lg:pt-[114px]">
                ...
                />
                <img src="https://res.cloudinary.com/djwj42mic/image/upload/v1729920397/Herobanner3_kuzaot.gif" alt="" className='w-full absolute top-0 left-0 md:hidden object-cover h-full' />
        ...
        <AnimatePresence mode='wait'>
            ...
            <div className="relative">
                <motion.div key={activeSlide} className=" h-[520px] md:h-[550px] lg:h-[627px] content flex lg:justify-center lg:pt-[114px]">
                    ...
                    />
                    <img
                        src="https://res.cloudinary.com/djwj42mic/image/upload/v1729920399/HeroBanner4_fr36xf.gif" className='w-full object-cover absolute top-0 md:hidden'
                    />
                    <div className="content space-y-4 absolute px-4 md:px-0 pt-6 lg:pt-0">
                        <motion.div
                            initial={{ scale: 0 }}
