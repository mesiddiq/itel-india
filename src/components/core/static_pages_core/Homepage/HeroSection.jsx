        ...
        >
            ...
            <SwiperSlide>
                <AnimatePresence mode='wait'>
                    <motion.div
                        key={activeSlide}
                        className="relative h-[520px] md:h-[550px] lg:h-[627px]  flex lg:items-center bg-[url('https://res.cloudinary.com/djwj42mic/image/upload/v1729920395/Hero_Bannerm_2_vhepy0.png')] lg:bg-[url('https://res.cloudinary.com/djwj42mic/image/upload/v1729919870/Hero_Banner_2_vcvtht.png')] bg-center bg-cover" >
                    ...
                    <div key={activeSlide} className="relative h-[520px] md:h-[550px] lg:h-[627px]  flex justify-center  lg:pt-[114px]">
                        ...
                        <div className="content space-y-4 absolute px-4 md:px-0 pt-6 lg:pt-0">
                            ...
                            <motion.h1
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 1, delay: 0.2 }}
                                className='text-mobile/h2 lg:text-desktop/h1 text-white font-bold'>The Ulitimate Hair <br /> Dryer Collection</motion.h1>
                            <motion.h5
                                initial={{ opacity: 0, y: 50 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 1, delay: 0.2 }}
            ...
            <SwiperSlide>
                ...
                <div key={activeSlide} className="relative h-[520px] md:h-[550px] lg:h-[627px]  flex lg:justify-center lg:pt-[114px]">
                    <img
