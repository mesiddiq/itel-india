...
const Form = () => {
 ...
 console.log(formData.selectedSubject)
 console.log(formData.message)
  const buttonData = [
    { img: "/Group%201973339728.png", title: "CALL US", info: "+91-120-6650888" },
    { img: "/Group%201973339728.png", title: "BUSINESS COOPERATION", info: "itelmarketing.in@transsion.com" },
    { img: "/Group%201973339728.png", title: "SUPPORT", info: "itel.care@transsion.com" },
  ];
      ...
      <div className='lg:bg-[url("/static_page/contactus/Form%20BG.webp")] bg-[url("/static_page/contactus/Form%20BG%20Mobile.webp")] lg:space-y-10 space-y-[32px] lg:min-h-[837px] lg:max-w-[735px] p-4 lg:p-[52px] bg-cover bg-center rounded-2xl'>
        ...
        <div className="text-brand/black space-y-[24px]">
          <div className="space-y-6">
            ...
            <div className="space-y-[12px] w-full">
              <p className="text-grey/grey/5 text-mobile/h6 lg:text-desktop/h6/medium">Message</p>
              <textarea
                name="message"
                placeholder="Enter your message here"
          ...
          <button
            ...
            className="py-3 space-x-2 rounded-full bg-[#1A1A1A] flex w-full items-center justify-center"
          >
            <p className="text-white text-desktop/button">SUBMIT</p>
            <img src="/static_page/homepage/arrow.png" alt="" />
          </button>
