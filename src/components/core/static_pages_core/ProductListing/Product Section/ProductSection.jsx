            ...
            <div className="tagPlusCards flex flex-col gap-8">
                ...
                <div className="hidden md:flex flex-col gap-12">
                    ...
                    <div className="sliderCounter flex flex-row gap-2 justify-center items-center w-full">
                        <img src={arrowLeftCarousel} className="p-3 cursor-pointer" onClick={prevPage} disabled={currentPage === 1}/>
                        <span className="text-sm leading-[22.4px] tracking-[-0.02em] text-[#F8F6F3]">{currentPage} of {totalPagesPerCategory}</span>
                        <img src={arrowRightCarousel} className="p-3 cursor-pointer" onClick={nextPage} disabled={currentPage === totalPagesPerCategory}/>
                    </div>
                </div>
