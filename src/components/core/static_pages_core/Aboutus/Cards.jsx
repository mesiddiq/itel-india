...
const Cards = () => {
  return (
    <div className='lg:bg-[url("/static_page/Aboutus/OurMissionBGVector.webp")] font-markot bg-[url("/static_page/Aboutus/OurMissionBGVector.webp")]  bg-cover bg-center bg-no-repeat '>
      <div className=" flex flex-col justify-between content   space-y-[60px] px-4 text-black ">
        <div className=" flex  lg:flex-row flex-col-reverse items-center  lg:space-y-0  lg:justify-end">
          <p className=" lg:pr-[100px] lg:text-desktop/h1 text-desktop/h2 text-brand/black">
            Enjoy Better <p className=" text-itel-red">Life</p>
          </p>
          <img
            className=" w-[290px] lg:w-[377px] lg:h-[468px] h-[360px]  "
            src="/static_page/Aboutus/OurMissionGraphic1.webp"
            alt=""
          />
        </div>
        <div className="  lg:relative lg:bottom-[150px] flex  lg:flex-row  flex-col items-center lg:justify-between ">
          <img
        ...
        <div className=" flex  lg:flex-row   flex-col-reverse lg:justify-between">
          <div className="   lg:w-[442px]  space-y-4">
            <p className="   text-mobile/h5 pt-3  lg:pt-0 lg:text-desktop/h4">
          ...
          <img
            className=" lg:relative bottom-[150px] lg:w-[728px] w-[319px] h-[199px] lg:h-[451px]"
