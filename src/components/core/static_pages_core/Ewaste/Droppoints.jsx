...
const Droppoints = () => {
  ...
  const indianStates = {
    "Uttar Pradesh": ["Allahabad", "Agra", "Noida"],
    "Haryana": ["Faridabad"],
    ...
    "Jharkhand": ["Ranchi"],
    "Gujarat": ["Vadodara"],
    "Madhya Pradesh": ["Ujjain", "Jabalpur", "Ashoknagar"],
    "Maharashtra": ["Thane", "Ghatkopar", "Bhiwandi", "Goregaon", "Dadar", "Virar"],
    "Telangana": ["Secunderabad", "Hyderabad"],
    "Tamil Nadu": ["Madurai", "Coimbatore"],
    "West Bengal": ["Siliguri", "Howrah"],
    "Kerala": ["Calicut"],
    "Assam": ["Guwahati"],
    "Meghalaya": ["Shillong"],
    "Tripura": ["Agartala"],
  ...
  const handleSearch = () => {
    if (selectedState && selectedCity) {
      const filtered = EWasteCityData.filter(
        (data) => data.state === selectedState && data.city === selectedCity
      );
        ...
        <div className="px-3 space-y-9 content">
          <div className="lg:bg-[url('/static_page/Ewaste/E-Waste%20Drop%20Points%20Banner.webp')] lg:py-[42px] lg:space-y-[32px] space-y-[16px] lg:px-0 px-[16px] py-[32px] rounded-2xl flex flex-col items-center bg-[url('/static_page/Ewaste/E-Waste%20Drop%20Points%20Banner%20Mobile.webp')] bg-center bg-cover lg:min-h-[432px] min-h-[549px]">
            ...
            <p
              ...
              className="text-brand/black underline cursor-pointer text-desktop/tertiary/cta"
            >
              See The Table
            </p>
