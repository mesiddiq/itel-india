    ...
    return (
        <section>
            <div className="bg-[#000000] px-4 md:px-0">
                <div className="font-clash content flex justify-between items-center lg:pt-20 pt-8 pb-2 lg:pb-5 lg:text-left text-center flex-col lg:flex-row gap-4">
            ...
            <div className="lg:h-[613px] h-[290px] md:h-[400px] bg-[url('/smartphone/zeno10/gobeyound/camera_withbg.webp')] bg-cover bg-center">
            </div>
        </section>
    )
}

export default BeyoundLimits