    ...
    return (
        <div className="py-3 lg:py-6 bg-[#242424] px-4 md:px-0">
            <div className="content flex justify-between items-center">
                ...
                <a href="https://www.amazon.in/dp/B0DQWR6WXH?ie=UTF8&ref_=itel_zeno_10_Website" target="_blank" className="lg:p-[12px_24px] p-[8px_14px] border-2 text-white hover:text-black transition-all duration-300 hover:bg-white border-zeno-solid flex gap-2 items-center rounded-full">
                    <span className="lg:text-desktop/button uppercase text-mobile/button font-markot">buy now</span>
