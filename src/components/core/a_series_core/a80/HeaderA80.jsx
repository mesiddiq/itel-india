    ...
    return (
        <div className={`${borderBottom ? 'border border-t-white/10' : 'border-none'} px-4 md:px-0 py-4 md:py-6 font-markot z-[999]`} style={{ background: bgColor ? bgColor : '#181818' }}>
            <div className="content flex justify-between">
                ...
                <a href={purchaseLink} target='_blank' className={`flex items-center py-3 px-[14px] md:px-6 rounded-[24px] gap-2  ${dark ? 'text-white bg-brand/black' : 'text-black/1 bg-white'}`}>
                    <p className={`text-mobile/button md:text-desktop/button ${dark ? 'text-white' : 'text-black'} uppercase font-medium`}>Buy Now</p>
