    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 px-2 lg:px-0 py-10 content">
              <div className="flex flex-col  justify-between lg:w-[518px] lg:h-[784px] h-[430px]">
                <GradientBackgroundWrapper bgImage={'/SmartPhone/a70/DisplaygridBG.webp'}  mobileBgImage={'/SmartPhone/a70/DisplaygridBG.webp'} paddingStart="0" padding="0">
                    ...
                    <div className="w-[316px] h-[430px] lg:w-[522px] lg:h-[822px] mx-auto"
                        style={{
                            backgroundImage: `url(${'/SmartPhone/a70/displaygrid-phone.webp'})`,
            ...
            <div className="flex flex-col gap-4 lg:w-[738px] lg:h-[784px]">
                <GradientBackgroundWrapper bgImage={'/SmartPhone/a70/slimdesigngridBG.webp'} mobileBgImage={'/SmartPhone/a70/slimdesigngridBG.webp'} paddingStart="0" padding="0">
                    <div className="flex flex-col  lg:w-[738px] h-[260px] lg:h-[380px] gap-10">
                        ...
                        <div className="flex justify-end">
                            <img src={'/SmartPhone/a70/slimdesigngrid-phone.webp'} alt="" className="w-[200px] h-[36px] lg:w-[577px] lg:h-[76px]" />
                        </div>
                    </div>
                </GradientBackgroundWrapper>

                <GradientBackgroundWrapper bgImage={'/SmartPhone/a70/ProcessorgridBG.webp'} mobileBgImage={'/SmartPhone/a70/Processorgrid-mobileBG.webp'} paddingStart="0" padding="0">
                    <div className=" flex flex-col lg:flex-row justify-between lg:w-[738px] h-[386px] lg:h-[380px] ">
                        ...
                        <div className="lg:w-1/2  flex items-center justify-center">
                            <img src={'/SmartPhone/a70/processorchip.webp'} alt="" className="z-10 w-[246px] h-[248px] lg:w-[300px] lg:h-[302px]" />
                        </div>
                    </div>
                </GradientBackgroundWrapper>
            </div>
