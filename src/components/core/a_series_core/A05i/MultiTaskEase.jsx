const MultiTaskEase = () => {
  return (
    <div className="hidden border border-black/10 relative md:flex flex-row overflow-hidden rounded-2xl md:rounded-[56px] bg-MultiTaskEaseGradient h-[740px] px-5 pt-5">
        
        <div className="flex flex-col justify-center items-center h-full w-[60%] rounded-2xl md:rounded-[56px]">
            <img src="/smartphone/A05i/MultiTaskEaseImage.png"/>
        </div>
