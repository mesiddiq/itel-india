        ...
        <div className="md:scale-75 lg:scale-100 flex flex-col justify-center items-center h-full w-1/2 rounded-2xl md:rounded-[56px] font-markot">
            <div className="flex flex-col justify-between gap-12 max-w-[500px]">
                <div className="flex flex-col gap-[18px]">
                    <h3 className="text-desktop/h2 text-[#232323]">4GB* (2GB + 2GB*) RAM for High Performance</h3>
                ...
                <div className="flex flex-col gap-[38px]">
                    <div className="flex flex-row gap-[40px]">
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="text-desktop/h3 text-[#0E0E0E]/80">2 More Apps</h3>
                            <h3 className="text-desktop/body/large text-[#232323]/80 max-w-[300px]">Running in the background</h3>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row gap-[40px]">
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="text-desktop/h3 text-[#0E0E0E]/80">20%</h3>
                            <h3 className="text-desktop/body/large text-[#232323]/80 max-w-[300px]">Reduced start-up time of frequently used apps</h3>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row gap-[40px]">
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="text-desktop/h3 text-[#0E0E0E]/80">36%</h3>
                            <h3 className="text-desktop/body/large text-[#232323]/80 max-w-[300px]">Faster Warm Boot of Apps</h3>
                        </div>
                    </div>
            ...
            <div className=" flex flex-col justify-center items-start h-full w-full rounded-2xl md:rounded-[56px] font-markot">
                <div className="flex flex-col justify-between gap-4 max-w-[296px]">
                    <div className="flex flex-col gap-[8px]">
                        <h3 className="text-mobile/h5/medium text-[#232323]">4GB* (2GB + 2GB*) RAM for High Performance</h3>
                    ...
                    <div className="flex flex-col gap-[12px]">
                        <div className="flex flex-row gap-[12px]">
                            ...
                            <div className="flex flex-col gap-1">
                                <h3 className="text-mobile/h6 text-[#0E0E0E]/80">2 More Apps</h3>
                                <h3 className="text-mobile/small/body text-[#232323]/80 max-w-[300px]">Running in the background</h3>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-row gap-[12px]">
                            ...
                            <div className="flex flex-col gap-1">
                                <h3 className="text-mobile/h6 text-[#0E0E0E]/80">20%</h3>
                                <h3 className="text-mobile/small/body text-[#232323]/80 max-w-[300px]">Reduced start-up time of frequently used apps</h3>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-row gap-[12px]">
                            ...
                            <div className="flex flex-col gap-1">
                                <h3 className="text-mobile/h6 text-[#0E0E0E]/80">36%</h3>
                                <h3 className="text-mobile/small/body text-[#232323]/80 max-w-[300px]">Faster Warm Boot of Apps</h3>
                            </div>
                        </div>
                    </div>
                </div>
