...
export default function Frame2() {
  return (
    ...
    <div className="flex flex-col justify-start items-center z-10 xl:px-[244.5px] xl:pt-[34px] px-[12px] pt-[16px] md:px-[20px] md:pt-[24px]">
        <h2 className="xl:text-desktop/h2 md:text-desktop/h3 text-mobile/h4 text-center max-w-full text-[#181818]">App Harmony: Speed Performance</h2>
