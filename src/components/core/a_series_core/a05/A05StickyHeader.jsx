...
const StickyHeader = ({ title, purchaseLink, icon, bgColor }) => {
    return (
        <div className='px-4 md:px-0 py-4 md:py-6 font-markot !sticky top-0 z-[999] border-b border-[#000] border-opacity-10' style={{ backgroundColor: bgColor ? bgColor : '#181818' }}>
            <div className="content flex justify-between">
                ...
                <div className="hidden md:flex gap-8 items-center">
                    ...
                    <a href="#specifications" className='text-desktop/body/1 text-black/1'>Specifications</a>
                </div>
                <a href={purchaseLink} target='_blank' className='flex py-3 px-[14px] md:px-6 rounded-[24px] bg-[#1A1A1A] gap-2'>
                    <p className='text-mobile/button md:text-desktop/button text-white uppercase font-medium'>Buy Now</p>
