    ...
    <div className="w-full flex md:py-[100px] md:px-[80px] py-[40px] px-[16px]">
      ...
      <div className="flex flex-col lg:flex-row w-full h-full justify-center items-center space-y-[12px] lg:space-y-0">
        ...
        <div className="flex flex-col space-y-[12px] lg:space-y-0 lg:h-[852px]">
          ...
          <div className="h-1/2 bg-[url('/smartphone/a50/f2S.webp')] bg-cover bg-center lg:flex hidden justify-start items-start border rounded-[16px] flex-grow md:mb-[24px]">
          ...
          <div className="h-1/2 bg-[url('/smartphone/a50/f3S.webp')] bg-cover bg-center flex lg:hidden flex-col justify-center items-center flex-grow rounded-[16px]">
          ...
          {/* Lower Right Block */}
          <div className="h-1/2 bg-[url('/smartphone/a50/f3S.webp')] bg-cover bg-center flex flex-col justify-center items-center flex-grow rounded-[16px]">
