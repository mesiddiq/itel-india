                ...
                <div className="flex flex-col gap-[40px] ">
                    <div className="flex flex-col gap-[32px] max-w-[450px]">
                        <div className="flex flex-col gap-[12px] max-w-[450px]">
                            <h1 className="text-desktop/h2 text-[#232323]">High-Performance Unisoc T603 Processor</h1>
                    ...
                    <div className="flex flex-row gap-[42px] max-w-[455px]">
                        <div className="flex flex-col gap-4">
                            ...
                            <h1 className="text-desktop/h6/medium text-[#0E0E0E] max-w-[180px]">Octa-Core Processor</h1>
                        </div>
                        <div className="flex flex-col gap-4">
                            <img src="/smartphone/A05i/gigaHertz.svg" alt='gigaHertz' className="w-[49px] h-[49px]"/>
                            <h1 className="text-desktop/h6/medium text-[#0E0E0E] max-w-[240px]">1.8 GHz Primary Clock Speed</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="md:scale-75 lg:scale-100 flex flex-col justify-center items-center h-full w-full rounded-2xl md:rounded-[56px] font-markot">
                <div className="flex flex-col justify-between items-center gap-[8px] h-auto max-w-[296px]">
                    <div className="text-center flex flex-col gap-2">
                        <h1 className="text-mobile/h4 text-[#232323]">High-Performance Unisoc T603 Processor</h1>
                    ...
                    <div className="flex flex-col gap-[8px]">
                        <h1 className="text-center text-mobile/h7 text-[#252525] max-w-[500px]">Efficient Information Processing | Smoother Entertainment | Smoother Running Time</h1>
                        <div className="flex flex-row  max-w-[296px]">
                            <div className="flex flex-row gap-3">
                                <img src="/smartphone/A05i/octaCore.svg" alt='octaCore' className="w-[32px] h-[32px]"/>
                                <h1 className="text-mobile/h7 text-[#0E0E0E] max-w-[101px]">Octa-Core Processor</h1>
                            </div>
                            <div className="flex flex-row gap-3">
                                <img src="/smartphone/A05i/gigaHertz.svg" alt='gigaHertz' className="w-[32px] h-[32px]"/>
                                <h1 className="text-mobile/h7 text-[#0E0E0E] max-w-[101px]">1.8 GHz Primary Clock Speed</h1>
                            </div>
                        </div>
                    </div>
                </div>
