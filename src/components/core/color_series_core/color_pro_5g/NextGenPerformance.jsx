...
const NextGenPerformance = () => {
  ...
  return (
    <div ref={containerRef} className='flex relative w-full h-[650px] md:h-[800px] px-[16px] md:px-[80px] py-[40px] md:py-[120px] bg-[url("/smartphone/color-pro-5g/NextGenPerformance/bg.png")] md:bg-none overflow-hidden'>
      <video
        ref={videoRef}
