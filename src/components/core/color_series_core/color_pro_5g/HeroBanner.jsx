        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 relative h-full md:justify-center md:items-center'>
          <div className='col-span-1 relative text-center'>
            <div className='w-full absolute top-[120px] md:top-[220px] z-[2]'>
              ...
              <p className='text-mobile/title md:text-desktop/title uppercase text-[#D9D9D9] font-markot pt-[10px] md:pt-[50px]'>IVCO <span className='lowercase'>itel</span> Vivid Color Technology<br />5G Network Connectivity | 12GB* (6GB+6GB)/8GB* (4GB+4GB) RAM + 128GB ROM</p>
