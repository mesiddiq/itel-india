    ...
    {/* <div className="bg-[#161616] w-full py-3 px-4 lg:px-20 lg:py-6"> */}
        <div className="flex flex-row justify-between items-center">
            ...
            <div className="flex flex-row justify-center items-center gap-3">
              ...
              <span className="text-mobile/h3 lg:text-desktop/h3 text-white font-markot">S24</span>
            </div>
            
            <div className="hidden lg:flex flex-row gap-8 text-desktop/h6/medium text-[#E8E8E8]">
                <span className="cursor-pointer font-markot">Overview</span>
                <span className="cursor-pointer font-markot">Specifications</span>
            </div>
