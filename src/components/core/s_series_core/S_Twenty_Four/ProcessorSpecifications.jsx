...
const CameraSpecifications = () => {
    return (
        <div className='relative font-markot lg:h-[1020px] h-[454px] bg-black overflow-hidden'>
            <img src="/smartphone/S24/processor-background.png" alt="Processor Background" className="absolute bottom-0 w-full"/>
            <img src="/smartphone/S24/processor.png" alt="Processor Image" className="w-1/2 lg:w-auto absolute top-[80%] lg:top-[60%] left-1/2 -translate-x-1/2 -translate-y-1/2"/>
            ...
            <div className='flex flex-col justify-center items-center gap-4 lg:gap-[42px] text-white absolute top-[40px] lg:top-[90px] w-full left-1/2 lg:transform -translate-x-1/2'>
                ...
                <div className='content w-[350px] lg:w-[779px] lg:max-w-[779px] lg:text-nowrap text-center lg:text-left flex flex-row gap-4 lg:gap-12 justify-between items-center'>
