import s23Camera from '/smartphone/S24/s23Camera.png'
import FeatureSpecifications from '../../../common/smartphone_common/FeatureSpecifications'

const CameraSpecifications = () => {
    return (
        <div className='relative lg:h-full h-[454px] bg-black overflow-hidden'>
            <img src={s23Camera} alt="Camera Specifications" className="w-full"/>
            ...
            <div className='flex flex-col justify-center items-center gap-4 lg:gap-[42px] text-white absolute bottom-16 md:bottom-8 lg:bottom-16 w-full left-1/2 lg:transform -translate-x-1/2'>
                ...
                <div className='flex flex-col justify-center items-center gap-2 lg:gap-[14px]'>
                    ...
                    <div className='FFMarkRegular text-mobile/small/body lg:text-desktop/h5'>
