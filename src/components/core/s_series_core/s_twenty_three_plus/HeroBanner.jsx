...
import heroImage from '../../../../images/s_series/s_twenty_three_plus/heroImage.png';
  ...
  return (
    <div className='hero-section md:items-center'>
      <div className='w-full md:w-1/2 p-4'>
        <img src={SuperSeries} className={`${secondaryAnimation ? '' : ''}`} />
      ...
      <div className='w-full md:w-1/2 p-4'>
        <img src={heroImage} className={`absolute bottom-0 right-0 h-[375px] md:h-full ${secondaryAnimation ? 'hero-section-image' : ''}`} alt='heroImage' />
      </div>
    </div>
  );
};
