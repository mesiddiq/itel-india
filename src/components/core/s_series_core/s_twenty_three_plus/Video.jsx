    ...
    <div className='w-full overflow-hidden relative items-center justify-center bg-[#050036] overflow-hidden' style={{ marginTop: '0px' }}>
      <Marquee speed='50' direction='right' autoFill={true}>
        <h3 className='flex items-center text-[#FFFFFF] text-[16px] md:text-[35px] font-[800] py-2'>
          <img src='/SmartPhone/S23+/Backgrounds/MarqueeIcon.png' alt='MarqueeIcon' className='px-3' /> <h1 className='linear-gradient text-[20px] font-bricolage font-[800] uppercase'>Super Series</h1>
          <img src='/SmartPhone/S23+/Backgrounds/MarqueeIcon.png' alt='MarqueeIcon' className='px-3' /> <h1 className='linear-gradient text-[20px] font-bricolage font-[800] uppercase'>incredibly super</h1>
        </h3>
      </Marquee>
