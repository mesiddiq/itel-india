      ...
      <div className='content'>
        ...
        <div className='grid grid-cols-[15%_85%] md:grid-cols-[25%_75%] relative'>
          <div className='col-span-1'>
            <img src='/s_twenty_three_plus/SharpFocusCardOneText.svg' alt='SharpFocusCardOneText' className='absolute w-[135px] md:w-auto left-[-12px] md:left-[80px] bottom-0 md:top-0' />
          </div>
          <div className='col-span-1'>
        ...
        <div className='md:hidden'>
          ...
          <div className='grid md:hidden grid-cols-[85%_15%] relative'>
            ...
            <div className='col-span-1'>
              <img src='/s_twenty_three_plus/SharpFocusCardTwoText.svg' alt='SharpFocusCardTwoText' className='absolute w-[135px] md:w-auto right-[-5px] bottom-0' />
            </div>
          </div>
          ...
          <div className='grid grid-cols-[15%_85%] relative'>
            <div className='col-span-1'>
              <img src='/s_twenty_three_plus/SharpFocusCardThreeText.svg' alt='SharpFocusCardThreeText' className='absolute w-[135px] md:w-auto left-[-12px] bottom-0' />
            </div>
            <div className='col-span-1'>
