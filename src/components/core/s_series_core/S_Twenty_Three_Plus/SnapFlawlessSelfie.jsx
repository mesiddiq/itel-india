      ...
      <div className='content'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div className='col-span-1 text-center md:text-left'>
            ...
            {showParagraph && (<p className='text-[#F2F2F2] text-mobile/body/2 md:text-desktop/body/large font-markot mb-[20px] md:mb-[80px] animate-slide-down'>Capture flawless selfies with advanced features like Ultra HD resolution, Beauty mode, and Wide Selfie for expansive group shots.</p>)}
            {showText && (
              <>
                <div className='hidden md:grid grid-cols-[160px_10px_60px] md:gap-4 animate-slide-down'>
