      ...
      <div className='content'>
        <div className='flex flex-col items-center md:top-[-60%]'>
          <div className='md:absolute md:left-[120px] md:bottom-0'>
            <h3 className={`linear-gradient text-mobile/h4 md:text-desktop/h2 font-markot mb-[10px] md:mb-[20px] md:w-[60%]`} data-aos="fade-down">Ultra-Thin Design: Perfectly Crafted for New Age Style</h3>
