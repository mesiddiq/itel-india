    ...
    <div className='block md:flex relative w-full h-[790px] md:h-[800px] px-[16px] md:px-0 pt-[12px] md:pt-[120px] pb-0 md:pb-[120px] bg-[url("/s_twenty_three_plus/PicturePerfect.svg")] bg-cover bg-center' style={{ marginTop: '0px' }}>
      <div className='md:flex md:content gap-4'>
        <div className='hidden md:flex w-[60%]'>
          {showPhone && (<img src='/s_twenty_three_plus/PicturePerfectPhone.png' className='absolute bottom-0' data-aos="fade-right" />)}
        </div>
        <div className='w-full md:w-[40%]'>
          ...
          <div className='grid grid-cols-2 gap-4 mt-[40px] md:mt-[80px]'>
            {showCardOne && (<div className='col-span-1' data-aos="fade-up">
            ...
            {showCardTwo && (<div className='col-span-1' data-aos="fade-up">
              <div className='flex md:flex-col items-start'>
            ...
            {showCardThree && (<div className='col-span-1' data-aos="fade-up">
              <div className='flex md:flex-col items-start'>
            ...
            {showCardFour && (<div className='col-span-1' data-aos="fade-up">
              <div className='flex md:flex-col items-start'>
        ...
        <div className='flex md:hidden w-full p-4 pb-0 pt-10'>
          {showPhoneMobile && (<img src='/s_twenty_three_plus/PicturePerfectPhone.png' data-aos="fade-down" />)}
        </div>
      </div>
    </div>
  );
