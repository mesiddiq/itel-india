function FeatureSection() {
  ...
  return (
    <section className="flex opacity-90 overflow-hidden z-0 flex-col h-auto justify-center px-5 max-md:px-0 py-[80px] max-md:py-0 max-md:pb-24 " style={{
      ...
      <div className="flex flex-col justify-center w-full max-md:max-w-full content ">
        <div className="flex flex-wrap justify-between items-start w-full max-md:max-w-full max-md:flex-col">
          ...
          <p className="text-desktop/body/2/regular md:text-desktop/body/1 text-zinc-300 w-[630px]  mt-6">
