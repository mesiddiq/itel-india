...
const LargeStorage = () => {
  return (
    ...
    style={{ backgroundImage: 'url(/smartphone/P55+/Backgrounds/LargeStorageBG.webp)' }}>
      <div className="content md:flex-row flex flex-col h-full items-center">
      <div className="flex flex-col font-markot gap-[48px] w-full p-4 md:p-0 md:w-1/2" data-aos="fade-right">
