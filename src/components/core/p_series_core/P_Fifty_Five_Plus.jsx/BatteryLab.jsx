...
const BatteryLab = () => {
  return (
    <div className='bg-cover w-full h-[550px] md:h-[860px] flex justify-center items-center bg-white py-12 px-[10px] lg:px-0'
   
    >
      <div className='content flex flex-col justify-between items-center font-markot h-full rounded-[16px] bg-cover bg-no-repeat'
      ...
      >
        <div className='flex flex-col justify-start gap-[26px] w-full p-[15px]'>
          <h2 className='text-mobile/h4 md:text-desktop/h2 text-center text-white'>Stay Supercharged; Battery Lab</h2>
        ...
        <div className='overflow-hidden'>
          <img src='/smartphone/P55+/Backgrounds/mobile.webp' alt='Long-lasting Battery Performance' className='md:w-[900px] md:h-[500px] h-[250px]'></img>
        </div>
      </div>
    </div>
  )
