...
const IdealCamera = () => {
  return (
    <div className="bg-[#D0E1FC] h-max py-10 lg:py-0 lg:h-[720px] w-full flex items-center justify-center bg-no-repeat bg-cover"
    style={{ backgroundImage: 'url(/smartphone/P55plus/idealcamera.png)' }}>
 ...
 <h2 className='text-mobile/h3 md:text-desktop/h2 text-[#B3D98E]'>Ideal Camera for All Your Needs</h2>
 <p className='text-[16px] lg:w-[500px]'>Click exceptional photos that showcase intricate details and unparalleled clarity, ensuring every aspect of your subjects shines with remarkable precision.</p>
    ...
    <div className="flex gap-[12px] items-center">
      <img src='/smartphone/P55plus/icon1.png'></img>
...
<p className='text-mobile/body/2 md:text-desktop/body/1'>AI Clear Portrait | Super Night Mode | Panorama Mode</p>
      ...
      <img src='/smartphone/P55plus/cameraimage.png'></img>
      </div>
      </div></div>
  )
}
