...
const MobileGrid = () => {
  ...
  <div className="content w-full h-full px-4 lg:p-0">
    ...
    >
      <div className="relative font-markot w-full md:w-[450px] lg:w-[522px] h-[450px] lg:h-[771px] bg-cover bg-gradient-to-r from-[#457EDC] to-[#101E53] rounded-[16px] overflow-hidden p-4 sm:p-8"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-2 gap-4 w-full">
        ...
        <div className="rounded-[16px] bg-gray-600 flex h-[159px] sm:h-[375px] bg-cover bg-center"
          style={{ backgroundImage: 'url(/SmartPhone/P55fiveg/Backgrounds/Web02.webp)' }}>
        ...
        <div className="rounded-[16px] bg-gray-500 flex h-[159px] sm:h-[375px] bg-cover bg-center"
          style={{
            backgroundImage: `linear-gradient(349.93deg, rgba(4, 34, 85, 0) 24.6%, #042255 66.8%), url("/SmartPhone/P55fiveg/Backgrounds/WebGrid03.webp")`,
          }}>
        ...
        <div className="rounded-[16px] bg-gray-600 flex h-[159px] sm:h-[375px] bg-cover bg-center "
          style={{ backgroundImage: 'url(/SmartPhone/P55fiveg/Backgrounds/WebGrid04.webp)' }}>
          <div className="flex flex-col pt-[16px] sm:pt-[23px] pl-[16px] sm:pl-[24px]">
        ...
        <div className="rounded-[16px] bg-[#004581] flex flex-col items-center justify-center h-[159px] sm:h-[375px] w-full">
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(circle at 48.75% 28.93%, rgba(0, 69, 129, 0.1) 0%, rgba(0, 55, 110, 0.1) 100%), url("/SmartPhone/P55fiveg/Backgrounds/WebGrid05.webp")`,
