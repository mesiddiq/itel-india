...
const MobileGrid = () => {
  return (
    <div className="flex flex-col justify-center items-center py-[80px] px-[40px] sm:py-[120px] sm:px-[80px] bg-black gap-[16px]">

      {/* Left side with a large box */}
      <div className='flex flex-col lg:flex-row justify-center items-center w-full'>
        <div className="relative w-full lg:w-[522px] h-[450px] lg:h-[771px] bg-gradient-to-r from-[#457EDC] to-[#101E53] rounded-[16px] overflow-hidden p-4 sm:p-8">
        ...
        <div className="flex flex-col lg:justify-between mt-4 lg:mt-0 lg:ml-4 w-full lg:w-auto">
          {/* Top two boxes */}
          <div className="flex  lg:flex-row justify-between mb-4 w-full">
            <div className="rounded-[16px] bg-gray-600 flex h-[159px] sm:h-[375px] w-full lg:w-[359px] mr-0 lg:mr-4 bg-cover bg-center" style={{ backgroundImage: 'url(/P_Series/5g.png)' }}>
            ...
            <div className="rounded-[16px] bg-gray-500 flex h-[159px] sm:h-[375px] w-full lg:w-[359px] bg-cover bg-center mt-4 lg:mt-0"
              style={{
          ...
          <div className="flex justify-between w-full">
            <div className="rounded-[16px] flex h-[159px] sm:h-[375px] w-full lg:w-[359px] mr-0 lg:mr-4 bg-cover bg-center" style={{ backgroundImage: 'url(/P_Series/6g.png)' }}>
              <div className='flex flex-col pt-[16px] sm:pt-[23px] pl-[16px] sm:pl-[24px]'>
                <p className='text-xs sm:text-sm lg:text-lg text-white'>
            ...
            <div className="rounded-[16px] bg-[#004581] flex flex-col items-center justify-center h-[159px] sm:h-[375px] w-full lg:w-[359px] mt-4 lg:mt-0">
      ...
      {/* Bottom section */}
      <div className="relative flex items-center justify-center bg-gradient-to-r from-blue-900 to-transparent w-full overflow-hidden rounded-[16px] mt-8 lg:mt-12">
        {/* Background Image */}
        <div
        ...
        {/* Text Section */}
        <div className="absolute top-1/4 left-4 sm:left-10 text-white z-20">
