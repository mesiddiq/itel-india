...
const LevelUpWithAndroid = () => {
  return (
      <div className='flex relative w-full h-[355px] md:h-[720px] pt-[15px] md:pt-[50px] bg-[url("/SmartPhone/p55T/LevelUpWithAndroidBg.png")] bg-cover bg-center overflow-hidden' style={{ marginTop: '0px' }}>
      	<div className='content relative'>
      		...
      		<div className='absolute right-[20%] top-[26%]'>
      		...
      		<div className='absolute right-[13%] top-[50%]'>
