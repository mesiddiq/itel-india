...
const Overview = (props) => {
  return (
    <div className='relative w-full px-[16px] md:px-0 py-[40px] md:py-[120px] h-[1000px] md:h-auto bg-[url("/smartphone/p55T/Backgrounds/HeroBanner.webp")] bg-cover bg-center' id='overview'>
