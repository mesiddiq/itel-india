...
const StayConnected = () => {
  return (
    <div className='flex relative w-full h-[750px] md:h-[720px] py-[50px] md:pt-[50px]' style={{ marginTop: '0px' }}>
    	<div className='content items-center px-[50px] md:px-[80px] bg-[url("/SmartPhone/p55T/Backgrounds/StayConnectedBgSmall.webp")] md:bg-[url("/SmartPhone/p55T/Backgrounds/StayConnectedBg.webp")] bg-contain bg-center bg-no-repeat'>
