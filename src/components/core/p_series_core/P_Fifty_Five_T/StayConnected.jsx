      	...
      	<div className='grid grid-cols-2 text-center md:text-left md:items-center h-full'>
      		<div className='col-span-2 md:col-span-1 w-[85%] md:w-[300px] lg:w-[400px] mx-auto md:mx-0 mt-14 md:mt-0'>
	      		...
	      		<div className='flex justify-between md:justify-start text-left pt-5'>
	      			<div>
		      			<h4 className='text-[#FFFFFF] text-mobile/h5/medium lg:text-desktop/h4 font-markot'>6000 mAh</h4>
		      			<p className='text-[#FFFFFF] text-mobile/body/2 lg:text-desktop/body/2/regular font-markot mt-2'>Powerful Battery</p>
		      		</div>
		      		<div className='pl-8'>
		      			<h4 className='text-[#FFFFFF] text-mobile/h5/medium lg:text-desktop/h4 font-markot'>18W</h4>
		      			<p className='text-[#FFFFFF] text-mobile/body/2 lg:text-desktop/body/2/regular font-markot mt-2'>Fast Charging</p>
		      		</div>
	      		</div>
	      	</div>
      	</div>
