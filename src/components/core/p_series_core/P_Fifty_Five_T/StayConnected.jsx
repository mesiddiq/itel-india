...
const StayConnected = () => {
  return (
    <div className='flex relative w-full h-[750px] md:h-[720px] py-[50px] md:pt-[50px]' style={{ marginTop: '0px' }}>
    	<div className='content items-center px-[50px] md:px-[80px] bg-[url("/SmartPhone/p55T/StayConnectedBgSM.png")] md:bg-[url("/SmartPhone/p55T/StayConnectedBg.png")] bg-contain bg-center bg-no-repeat'>
      	<div className='grid grid-cols-2 text-center md:text-left md:items-center h-full'>
      		<div className='col-span-2 md:col-span-1 w-[85%] md:w-full mx-auto md:mx-0 mt-14 md:mt-0 md:w-[480px]'>
