...
const MasonaryCards = () => {
  return (
      <div className='flex relative w-full px-[16px] md:px-0 py-[40px] md:py-[120px] bg-[#181818]'>
      	<div className='content'>
	      	<div className='grid grid-cols-2 md:grid-cols-[40%_30%_30%] gap-4'>
	      		<div className='col-span-2 md:col-span-3 h-[250px] md:h-[470px] rounded-[16px] bg-[url("/smartphone/p55T/Backgrounds/MobileGrid1.webp")] md:bg-[url("/smartphone/p55T/Backgrounds/WebGrid1.webp")] bg-cover bg-center bg-no-repeat' data-aos='zoom-down'>
	      		...
	      		<div className='col-span-2 md:col-span-1 md:row-span-2 h-[520px] md:h-auto rounded-[16px] bg-[url("/smartphone/p55T/Backgrounds/MobileGrid2.webp")] md:bg-[url("/smartphone/p55T/Backgrounds/WebGrid2.webp")] bg-cover bg-center bg-no-repeat' data-aos='zoom-right' data-aos-delay='500'>
	      		...
	      		<div className='col-span-2 h-[245px] md:h-[375px] rounded-[16px] bg-[url("/smartphone/p55T/Backgrounds/MobileGrid3.webp")] md:bg-[url("/smartphone/p55T/Backgrounds/WebGrid3.webp")] bg-cover bg-center bg-no-repeat' data-aos='zoom-left' data-aos-delay='1000'>
	      			<div className='flex flex-col md:flex-row h-full'>
