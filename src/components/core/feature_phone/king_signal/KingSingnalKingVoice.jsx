...
const KingSignalKingVoice = () => {

    const KingVoiceDataCircle1 = {
        phoneUrl: '/featurephone/king_signal/product/king_voice.webp',
        bgColor: '#041721',
        borderColor: '#418BCE',
        textColor: '#fff',
        cards: [
            {
                id: '1',
                label: 'Incoming Calls & Message',
                icon: '/featurephone/king_signal/icons/call_king_signal.svg'
            },
            {
                id: '2',
                label: 'Reading Menu & Phonebook',
                icon: '/featurephone/king_signal/icons/addressbook_king_signal.svg'
            },
            {
                id: '3',
                label: 'Dialling Number',
                icon: '/featurephone/king_signal/icons/numpad_king_signal.svg'
            },
            {
                id: '4',
                label: 'Instant Reading',
                icon: '/featurephone/king_signal/icons/reading_king_signal.svg'
            },
            {
                id: '5',
                label: 'Customisation Support',
                icon: '/featurephone/king_signal/icons/support_king_signal.svg'
            },
            {
                id: '6',
                label: 'Time Update',
                icon: '/featurephone/king_signal/icons/time_king_signal.svg'
            },
        ]
    }
    ...
    return (
        <div className={`flex flex-col overflow-hidden items-center  relative gap-6 xl:gap-14 pb-[366px] pt-9 xl:pb-[116px] xl:pt-12`} style={{ backgroundColor: bgColor }}>
            <div className="">
                <div className={`flex justify-center border-2 relative rounded-s border-[#418BCE]`}>
                    <div className="bg-[#041721] absolute -translate-y-1/2  px-3 xl:px-5">
                        <h3 className={`text-mobile/h6 xl:text-desktop/h3 font-markot text-center bg-gradient-to-r from-[#fff] to-[#fff] text-transparent bg-clip-text`} >A Phone That Speaks For You</h3>
                    </div>
                    <h1 className='uppercase text-[94px] md:text-[150px] text-center md:leading-[140px] lg:text-[160px] lg:leading-[200px] xl:text-[200px] xl:leading-[240px] 2xl:text-[240px] 2xl:leading-[286px] font-bold leading-[94px] font-markot px-5 2xl:px-0 py-4 2xl:py-5 bg-gradient-to-r from-[#15D582] to-[#106DE7] text-transparent bg-clip-text'>
                        <span className='tracking-[15px] font-markot '>king</span><br className='lg:hidden' />
                        <div className='-tracking-[3.7px] inline'>v
                            <div className='relative inline'>
                                <span className='bg-gradient-to-r from-[#56a181] to-[#106DE7] text-transparent bg-clip-text'>o</span>
            ...
            <div className="grid gap-x-4 gap-y-3 xl:gap-y-10 grid-cols-2 xl:gap-x-[622px] font-markot relative">
                <For each={cards} render={({ label, icon }, idx) =>
                    <div className="gap-2 flex  xl:gap-4 xl:w-[259px] items-center" key={idx} data-aos="fade-up">
                        <div className="xl:min-h-[54px] max-h-8 max-w-8 xl:min-w-[54px] xl:rounded-[8px] rounded-[4px] flex items-center justify-center bg-white/10">
                            <img src={icon} alt={label} className='xl:min-h-8 xl:min-w-8 min-h-5 min-w-5' />
                        </div>
                        <h3 className='text-mobile/h7 xl:text-desktop/h5/medium bg-gradient-to-r from-[#fff] to-[#fff] text-transparent bg-clip-text max-w-[116px] md:max-w-full'>{label}</h3>
                    </div>
                } />
            </div>
            <img src={phoneUrl} alt="Super Guru 4g" loading='lazy' className='absolute bottom-0 left-1/2 top-[440px] xl:top-[278px] -translate-x-1/2 max-w-[298px] max-h-[760px] xl:max-w-[590px] ' />
        </div>
    )
}

export default KingSignalKingVoice