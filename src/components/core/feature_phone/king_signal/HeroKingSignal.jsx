...
const HeroKingSignal = ({ title, subtitle, phoneUrl, purchaseLink, bgDesktop, bgMobile, dark }) => {
            ...
            <div className="content flex flex-col lg:flex-row gap-4 lg:gap-0 lg:justify-between items-center px-4 md:px-0 relative">
                <div className="space-y-4 lg:space-y-9 w-full">
                    <div className="space-y-2 lg:space-y-3">
                        <h1 className={`text-mobile/h1 lg:text-desktop/h1 ${dark && 'text-black/1'}`} data-aos="fade-right">
                            King <span className="text-king-signal"> Signal</span>
                        </h1>
                        <p className={`text-mobile/title lg:text-[20px] lg:leading-6 lg:tracking-[0.2px] font-normal uppercase text-grey/grey/1 ${dark && 'text-grey/grey/5'} max-w-[564px]`} data-aos="fade-right" data-aos-delay="400">Super strong signal | 1500mAh | Auto call recording</p>
                    </div>
