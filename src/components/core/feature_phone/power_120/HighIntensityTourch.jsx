const HighIntensityTourch = () => {
    return (
        <div className="bg-center px-4 md:px-0 font-markot lg:h-[850px] py-[100px] overflow-hidden w-full bg-[url('/featurephone/Power_120/Backgrounds/torch_mobile.webp')] md:bg-[url('/featurephone/Power_120/Backgrounds/torch_bg.webp')] bg-cover bg-no-repeat">
