            ...
            <div className="content h-[697px] lg:h-[720px] flex items-center lg:justify-between relative flex-col lg:flex-row pt-9 lg:pt-0">
                <div className="max-w-[574px] flex-col flex gap-5 lg:gap-[46px]">
                    <div className="space-y-3 lg:space-y-5">
                        <h3 className="text-mobile/h4 lg:text-featurephone/heading text-bg/primary/1">Unlimited Energy: 2000 mAh Battery</h3>
                    ...
                    <div className="flex lg:flex-col gap-[10px] lg:gap-5 lg:max-w-[253px]">
                        <div className="flex flex-col gap-1 lg:gap-2">
                            <h3 className="text-moblie/h6 lg:text-desktop/h4 text-white/80 ">13 Days* </h3>
                        ...
                        <div className="flex flex-col gap-1 lg:gap-2">
                            <h3 className="text-moblie/h6 lg:text-desktop/h4 text-white/80 text-nowrap">20 Hours* </h3>
                            <p className="text-mobile/small/body lg:text-desktop/body/1 text-white/80 ">Talktime</p>
                        </div>
                        <div className="min-h-full lg:h-[1px] lg:w-full w-[1px] bg-grey/grey/3"></div>
                        <div className="flex flex-col gap-1 lg:gap-2">
                            <h3 className="text-moblie/h6 lg:text-desktop/h4 text-white/80 ">Super Battery Mode </h3>
                        </div>
                    </div>
                </div>
                ...
                <h3 className="text-mobile/small/body lg:text-desktop/body/1 text-grey/grey/2/80 absolute bottom-1 right-0">*theoretical value in ideal conditions</h3>
            </div>
        </div>
    )
}
