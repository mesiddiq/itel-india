...
const Circle1KingVoice = () => {
    ...
    return (
        <div className={`flex flex-col overflow-hidden items-center  relative gap-6 lg:gap-14 pb-[366px] pt-9 lg:pb-[116px] lg:pt-12`} style={{ backgroundColor: bgColor }}>
            <div className="">
                <div className={`flex justify-center border-2 relative rounded-s border-[#ff998f]`}>
                    <div className="bg-[#1c1b1b] absolute -translate-y-1/2  px-3 lg:px-5">
                        <h3 className={`text-mobile/h6 lg:text-desktop/h3 font-markot text-center bg-gradient-to-r from-[#ff998f] to-[#fff7e8] text-transparent bg-clip-text`} >A Phone That Speaks For You</h3>
                    </div>
                    <h1 className='uppercase text-[94px] lg:text-[240px] lg:leading-[286px] font-bold leading-[94px] font-markot px-5 lg:px-0 bg-gradient-to-r from-[#ff998f] to-[#fff7e8] text-transparent bg-clip-text' data-aos="fade-up">
            ...
            <div className="grid gap-x-4 gap-y-3 lg:gap-y-10 grid-cols-2 lg:gap-x-[622px] font-markot relative">
                <For each={cards} render={({ label, icon }, idx) =>
                    <div className="gap-2 flex  lg:gap-4 lg:w-[259px] items-center" key={idx} data-aos="fade-up">
                        ...
                        <h3 className='text-mobile/h7 lg:text-desktop/h5/medium bg-gradient-to-r from-[#ff998f] to-[#fff7e8] text-transparent bg-clip-text max-w-[116px] md:max-w-full'>{label}</h3>
                    </div>
                } />
            </div>
