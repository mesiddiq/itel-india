...
const Circle1KingVoice = () => {

    const KingVoiceDataCircle1 = {
        phoneUrl: '/featurephone/Circle_1/Backgrounds/king_voice.webp',
        bgColor: '#1C1B1B',
        borderColor: '#3A3358',
        textColor: '#fff',
        cards: [
            { id: '1', label: 'Incoming Calls & Message', icon: '/featurephone/Circle_1/Backgrounds/PhoneCall.svg' },
            { id: '2', label: 'Reading Menu & Phonebook', icon: '/featurephone/Circle_1/Backgrounds/BookOpenText.svg' },
            { id: '3', label: 'Dialling Number', icon: '/featurephone/Circle_1/Backgrounds/Numpad.svg' },
            { id: '4', label: 'Instant Reading', icon: '/featurephone/Circle_1/Backgrounds/AddressBook.svg' },
            { id: '5', label: 'Customisation Support', icon: '/featurephone/Circle_1/Backgrounds/UserCircleGear.svg' },
            { id: '6', label: 'Time Update', icon: '/featurephone/Circle_1/Backgrounds/Clock.svg' },
        ]
    }

    const { phoneUrl, bgColor, borderColor, textColor, cards } = KingVoiceDataCircle1

    return (
        <div className={`flex flex-col overflow-hidden items-center  relative gap-6 xl:gap-14 pb-[366px] pt-9 xl:pb-[116px] xl:pt-12`} style={{ backgroundColor: bgColor }}>
            <div className="">
                <div className={`flex justify-center border-2 relative rounded-s border-[#ff998f]`}>
                    ...
                    <h1 className='uppercase text-[94px] xl:text-[210px] xl:leading-[286px] font-bold leading-[94px] font-markot px-5 xl:px-0 bg-gradient-to-r from-[#ff998f] to-[#fff7e8] text-transparent bg-clip-text' data-aos="fade-up">
                        <span className='tracking-[15px] font-markot '>king</span><br className='xl:hidden' />
                        <div className='-tracking-[3.7px] inline'>v
                            <div className='relative inline bg-gradient-to-r from-[#ff998f] to-[#fff7e8] text-transparent bg-clip-text'>
                                o
                                <svg width="92" className='size-6 xl:size-[92px] absolute top-[52%] left-[53%] -translate-x-1/2 -translate-y-1/2' height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="grid gap-x-4 gap-y-3 xl:gap-y-10 grid-cols-2 xl:gap-x-[622px] font-markot relative">
                <For each={cards} render={({ label, icon }, idx) =>
                    <div className="gap-2 flex  xl:gap-4 xl:w-[259px] items-center" key={idx} data-aos="fade-up">
                        <div className="xl:min-h-[54px] max-h-8 max-w-8 xl:min-w-[54px] xl:rounded-[8px] rounded-[4px] flex items-center justify-center" style={{ background: borderColor }}>
                            <img src={icon} alt={label} className='xl:min-h-8 xl:min-w-8 min-h-5 min-w-5' />
                        </div>
                        <h3 className='text-mobile/h7 xl:text-desktop/h5/medium bg-gradient-to-r from-[#ff998f] to-[#fff7e8] text-transparent bg-clip-text max-w-[116px] md:max-w-full'>{label}</h3>
                    </div>
                } />
            </div>
            <img src={phoneUrl} alt="Super Guru 4g" loading='lazy' className='absolute bottom-0 left-1/2 top-[440px] xl:top-[278px] -translate-x-1/2 max-w-[298px] max-h-[760px] xl:max-w-[490px] ' />
        </div>
    )
}

export default Circle1KingVoice