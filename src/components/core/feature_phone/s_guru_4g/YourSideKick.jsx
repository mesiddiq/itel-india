...
const YourSideKick = () => {
    ...
    return (
        <div ref={elementRef} className='h-[720px] relative bg-bg/secondry px-4 md:px-0 font-markot pt-7 lg:pt-[178px]' style={{ background: `#ebe9e2 ${width < 1024 ? 'url(/featurephone/superguru4g/roundbgphone.svg) bottom -10% center/100%  no-repeat' : 'url(/featurephone/superguru4g/roundbg.svg) 100% 100% no-repeat'} ` }}>
