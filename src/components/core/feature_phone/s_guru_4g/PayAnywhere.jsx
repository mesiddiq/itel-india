...
const PayAnywhere = () => {
    return (
        <div className='rounded-[16px] overflow-hidden h-[430px] lg:h-auto lg:rounded-[24px] relative bg-bg/secondry content py-[26px] lg:py-[89px] px-[24px] lg:px-[114px]'>
            ...
            <img src="/featurephone/superguru4g/upiphone.png" alt="UPI Enabled Phone" className='absolute bottom-0 right-0 h-[284px] lg:h-[450px] w-[209px] object-contain md:w-auto' />
        </div>
    )
}
