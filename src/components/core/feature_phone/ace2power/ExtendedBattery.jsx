...
const ExtendedBattery = () => {
    return (
        <div className='bg-[url("/featurephone/Ace2Power/Backgrounds/extended_battery_mobile.webp")] overflow-hidden relative bg-cover bg-center bg-no-repeat px-4 md:px-0 font-markot lg:bg-[url("/featurephone/Ace2Power/Backgrounds/extended_battery.webp")] lg:h-[650px]'>
            <div className="flex items-center h-full gap-[60px] content justify-end">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4 max-w-[437px] lg:text-left text-center">
                        ...
                        <h1 className="text-mobile/h4 lg:text-desktop/h2 text-black/1">Extended Battery Life: Up to 21 Days*</h1>
